Feature: User Registration
  ...
  Scenario Outline: Register user with invalid or empty details
    ...
    Examples:
      ...
      |            | Patel       | Singh     | user_283 | bharath@gmail.com | First name required /Invalid                  |
      | priya      |             | Sharma    |          | abc@example.com   | middle name required /Invalid                 |
      | Siddharth  | Kumar       |           | user_123 | xyz@example.com   | Last name required /Invalid                   |
      |            |             |           | user_456 | def@example.com   | First,Middle,Last name Required /Invalid data |
      |            |             |           |          |                   | Fields empty                                  |
      |            |             | Patel     | user_g12 | mno@example.com   | First and Middle name is Required / Invalid   |
      |            | Sharma      |           | use_jk21 | stu@example.com   | First and Last name is Required / Invalid     |
      | Arjun      |             |           | user_b12 | raj@example.com   | Middle and Last name is Required / Invalid    |
      | Pooja      | Patel       | Singh     |          | raja@example.com  | user name is Required / Invalid               |
      | Pady       | Patel       | Singh     | user_123 |                   | mail is  Required / Invalid                   |
